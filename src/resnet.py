...
def conv1d_3(in_planes, out_planes, stride=1, groups=1, dilation=1):
    """3x1 convolution with padding"""
    return nn.Conv1d(in_planes, out_planes, kernel_size=3, stride=stride,
                     padding=dilation, groups=groups, bias=False, dilation=dilation)


def conv1d_1(in_planes, out_planes, stride=1):
    """1x1 convolution"""
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_channels=4, n_logits=1000,
        ...
        self.conv1 = nn.Conv1d(in_channels, self.inplanes, kernel_size=7,
        ...
        self.fc = nn.Linear(512 * block.expansion, n_logits)
...
def resnet34(**kwargs):
    r"""ResNet-34 model architecture adapted from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    """
...
def resnet101(**kwargs):
    r"""ResNet-101 model architecture adapted from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    """
...
def resnet152(**kwargs):
    r"""ResNet-152 model architecture adapted from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
...
def resnext50_32x4d(**kwargs):
    r"""ResNeXt-50 32x4d model architecture adapted from
...
def resnext101_32x8d(**kwargs):
    r"""ResNeXt-101 32x8d model architecture adapted from
    `"Aggregated Residual Transformation for Deep Neural Networks" <https://arxiv.org/pdf/1611.05431.pdf>`_
...
def wide_resnet50_2(**kwargs):
    r"""Wide ResNet-50-2 model architecture adapted from
...
def wide_resnet101_2(**kwargs):
    r"""Wide ResNet-101-2 model architecture adapted from
    `"Wide Residual Networks" <https://arxiv.org/pdf/1605.07146.pdf>`_
